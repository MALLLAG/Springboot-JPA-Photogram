...
public class UserApiController {
	...
	public ResponseEntity<?> profileImageUrlUpdata(@PathVariable int principalId, MultipartFile profileImageFile,
	...
	public CMRespDto<?> update(
			...
			BindingResult bindingResult, // Valid가 적힌 파라메터 뒤에 적어야함
			@AuthenticationPrincipal PrincipalDetails principalDetails) {
